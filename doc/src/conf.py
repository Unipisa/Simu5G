...
project = 'Simu5G'
copyright = 'Simu5G authors'
author = 'Simu5G authors'
...
html_theme_options = {
    ...
    'header_links' : [
#        ("Simu5G Website", "https://simu5g.org", True, 'language'),
...
man_pages = [
    (master_doc, 'simu5g', 'Simu5G Documentation',
     [author], 1)
]
