...
sudo route add -net 10.0.0.0 netmask 255.0.0.0 dev veth1        # to ue
sudo route add -net 192.168.8.0 netmask 255.255.255.0 dev veth1     # to mecPlatform
sudo route add -net 192.168.2.0 netmask 255.255.255.0 dev veth1     # to mecPlatform
