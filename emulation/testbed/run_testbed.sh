...
# add routes for  client and server hosts
sudo route add -net 192.168.56.0 netmask 255.255.255.0 dev eth0
sudo route add -net 192.168.55.0 netmask 255.255.255.0 dev eth1
...
# run simulation
simu5g -u Cmdenv -c ExtClientServer_Testbed
