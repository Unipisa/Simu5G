...
do
    ...
    do
        ...
        RTT_OUTPUT_FILE="rtt-backgroundUes-ca=${CA}-rbs=${RBS}-dynamicPhy=false.csv"
        ...
        do
            ...
            do
                ORIG=`pwd`
                SUBDIR="backgroundUes-ca=${CA}-u=$NUMEROLOGY-rbs=$RBS-sndInt=${SNDINT}-bkUEs=${BKUES}-dynamicPhy=false-#0"
                cd $SUBDIR
