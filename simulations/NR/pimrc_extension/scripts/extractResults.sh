...
for U in 0; do
    for UES in 50; do
            ...
            INPUTFILE=$INPUTDIR/u=${U}*UEs=${UES}-*.sca
            
            OUTPUTFILE=$OUTPUTDIR/sca_rcvdSinrDl_u=${U}_ues=${UES}.csv
            ...
            OUTPUTFILE=$OUTPUTDIR/sca_rcvdSinrUl_u=${U}_ues=${UES}.csv
