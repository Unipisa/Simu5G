...
class LteSchedulerEnbUl : public LteSchedulerEnb
{
  ...
  public:
     ...
     */
    bool racschedule(GHz carrierFrequency, BandLimitVector *bandLim = nullptr) override;
    virtual void racscheduleBackground(unsigned int& racAllocatedBlocks, GHz carrierFrequency, BandLimitVector *bandLim = nullptr);
     ...
     */
    virtual void signalRac(MacNodeId nodeId, GHz carrierFrequency)
    {
